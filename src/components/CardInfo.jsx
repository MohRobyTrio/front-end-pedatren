            ...
            <div className="flex items-start gap-4 pt-4">
                ...
                <div className="flex-1 min-w-0">
                    <div className="grid grid-cols-1 gap-y-1 text-xs sm:text-sm">
                        ...
                        {waliAsuh.nama_lembaga && (
                            <div className="flex flex-wrap items-start gap-x-1">
                                <span className="font-semibold text-gray-700 whitespace-nowrap">Lembaga</span>
                                <span className="text-gray-600 break-words">: {waliAsuh.nama_lembaga}</span>
                            </div>
                        )}
                        <div className="flex flex-wrap items-start gap-x-1">
                            <span className="font-semibold text-gray-700 whitespace-nowrap">Wilayah</span>
                            <span className="text-gray-600">: {waliAsuh.wilayah || waliAsuh.nama_wilayah}</span>
                        </div>
                        <div className="flex flex-wrap items-start gap-x-1">
                            <span className="font-semibold text-gray-700 whitespace-nowrap">Blok</span>
                            <span className="text-gray-600">: {waliAsuh.blok || waliAsuh.nama_blok}</span>
                        </div>
                        <div className="flex flex-wrap items-start gap-x-1">
                            <span className="font-semibold text-gray-700 whitespace-nowrap">Kamar</span>
                            <span className="text-gray-600">: {waliAsuh.kamar || waliAsuh.nama_kamar}</span>
                        </div>
                    </div>
                </div>
            </div>
