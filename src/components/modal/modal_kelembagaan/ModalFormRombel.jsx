...
export const ModalAddOrEditRombel = ({ isOpen, onClose, data, refetchData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const isEdit = data;
            const url = isEdit
                ? `${API_BASE_URL}crud/rombel/${data.id}`
                : `${API_BASE_URL}crud/rombel`;
            ...
            const payload = isEdit
                ? {
                    ...
                    gender_rombel: formData.gender_rombel,
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-2 sm:mt-0 text-left w-full">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <label htmlFor="gender_rombel" className="block text-gray-700">Gender Rombel *</label>
                                                    <div className="flex space-x-4 mt-1">
                                                        <label className="inline-flex items-center">
                                                            <input
                                                                ...
                                                                name="gender_rombel"
                                                                value="putra"
                                                                checked={formData.gender_rombel == "putra"}
                                                                onChange={(e) => setFormData({ ...formData, gender_rombel: e.target.value })}
                                                        ...
                                                        <label className="inline-flex items-center">
                                                            <input
                                                                ...
                                                                name="gender_rombel"
                                                                value="putri"
                                                                checked={formData.gender_rombel == "putri"}
                                                                onChange={(e) => setFormData({ ...formData, gender_rombel: e.target.value })}
                                                                className="form-radio text-blue-500 focus:ring-blue-500"
                                                                required
                                                            />
...
export const ModalDetailRombel = ({ isOpen, onClose, id }) => {
    console.log(id);
    ...
    useEffect(() => {
        if (isOpen && id) {
            const token = sessionStorage.getItem("token") || getCookie("token");
            setLoading(true);
            fetch(`${API_BASE_URL}crud/rombel/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
                },
                ...
                <div className="flex items-center justify-center min-h-screen px-4 py-8 text-center">
                    ...
                    >
                        <Dialog.Panel className="bg-white rounded-lg shadow-xl max-w-lg w-full h-full relative max-h-[90vh] flex flex-col">
                            ...
                            {/* Header */}
                            <div className="pt-6">
                                <Dialog.Title className="text-lg font-semibold text-gray-900">Detail Rombel</Dialog.Title>
                            </div>
                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-2">
                                        {[
                                            ...
                                            ["Gender Rombel", data.gender_rombel],
                                    ...
                                    <p className="text-red-500">Gagal memuat data jurusan.</p>
                                )}
                            </div>
