...
const ModalAddOrEditJamPelajaran = ({ isOpen, onClose, data, refetchData, feature }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            if (feature == 2 && data) {
                const formatTime = (time) => time ? time.substring(0, 5) : ""; // ambil HH:mm

                setFormData({
                    jam_ke: data.jam_ke || "",
                    label: data.label || "",
                    jam_mulai: formatTime(data.jam_mulai),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = isEdit
                ? `${API_BASE_URL}crud/jam-pelajaran/${id}`
                : `${API_BASE_URL}crud/jam-pelajaran`;
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-2 sm:mt-0 text-left w-full">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <label htmlFor="jam_ke" className="block text-gray-700">Jam Ke *</label>
                                                    <input
                                                        type="text"
                                                        inputMode="numeric"
                                                        onInput={(e) => {
                                                ...
                                                <div>
                                                    <label htmlFor="jam_mulai" className="block text-gray-700">Jam Mulai *</label>
                                                    <input
                                                        type="time"
                                                        id="jam_mulai"
                                                        name="jam_mulai"
                                                ...
                                                <div>
                                                    <label htmlFor="jam_selesai" className="block text-gray-700">Jam Selesai *</label>
                                                    <input
                                                        type="time"
                                                        id="jam_selesai"
                                                        name="jam_selesai"
...
export default ModalAddOrEditJamPelajaran;