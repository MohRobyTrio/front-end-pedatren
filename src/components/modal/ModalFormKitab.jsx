...
export const ModalAddOrEditKitab = ({ isOpen, onClose, data, refetchData, feature }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                nama_kitab: formData.nama_kitab,
                total_bait: formData.total_bait,
            };
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-2 sm:mt-0 text-left w-full">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label htmlFor="nama_kitab" className="block text-gray-700">Nama Kitab *</label>
                                                    <input
                                                        type="text"
                                                        id="nama_kitab"
                                                        name="nama_kitab"
                                                        value={formData.nama_kitab}
                                                        onChange={(e) => setFormData({ ...formData, nama_kitab: e.target.value })}
                                                        maxLength={100}
                                                        required
                                                ...
                                                <div>
                                                    <label htmlFor="total_bait" className="block text-gray-700">Total Bait *</label>
                                                    <input
                                                        type="text"
                                                        inputMode="numeric"
                                                        onInput={(e) => {
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, total_bait: e.target.value })}
                                                        maxLength={255}
                                                        required
                                                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                                        placeholder="Masukkan Total Bait"
                                                    />
                                                </div>
                                            </div>
                                        </div>
...
export const ModalDetailKitab = ({ isOpen, onClose, id }) => {
    console.log(id);
                ...
                <div className="flex items-center justify-center min-h-screen px-4 py-8 text-center">
                    ...
                    >
                        <Dialog.Panel className="bg-white rounded-lg shadow-xl max-w-lg w-full h-full relative max-h-[90vh] flex flex-col">
                            ...
                            {/* Header */}
                            <div className="pt-6">
                                <Dialog.Title className="text-lg font-semibold text-gray-900">Detail Kitab</Dialog.Title>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto pr-8 pl-8 pt-4 text-left">
                                {loading ? (
                                    ...
                                    <div className="space-y-2">
                                        {[
                                            ["Nama Kitab", data.nama_kitab],
                                            ["Total Bait", data.total_bait]
                                        ]
                                            .map(([label, value]) => (
                                    ...
                                    <p className="text-red-500">Gagal memuat data kitab.</p>
                                )}
                            </div>
