...
export const ModalAddOrEditSholat = ({ isOpen, onClose, data, refetchData, feature }) => {
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-2 sm:mt-0 text-left w-full">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label htmlFor="nama_sholat" className="block text-gray-700">Nama Sholat *</label>
                                                    <input
                                                        type="text"
                                                        id="nama_sholat"
                                                        name="nama_sholat"
                                                        value={formData.nama_sholat}
                                                        onChange={(e) => setFormData({ ...formData, nama_sholat: e.target.value })}
                                                        maxLength={20}
                                                        required
                                                        className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                                        placeholder="Masukkan Nama Sholat"
                                                    />
                                                </div>
                                                <div>
                                                    <label htmlFor="urutan" className="block text-gray-700">Urutan *</label>
                                                    <input
                                                        type="text"
                                                        inputMode="numeric"
                                                        onInput={(e) => {
