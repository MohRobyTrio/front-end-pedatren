...
export const ModalAddPengurusFormulir = ({ isOpen, onClose, biodataId, cardId, refetchData, feature }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.satuan_kerja || !formData.golongan_jabatan_id || !formData.keterangan_jabatan || !formData.tanggal_masuk) {
            await Swal.fire({
                icon: "error",
                                ...
                                <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                className="w-full mt-1 border border-gray-300 rounded-md p-2"
                                                value={formData.jabatan_kontrak}
                                                onChange={(e) => setFormData({ ...formData, jabatan_kontrak: e.target.value })}
                                            >
