...
export default function MultiStepModalAnakPegawai({ isOpen, onClose, formState }) {
    ...
    // Sinkronkan nilai ke field register (tinggal_bersama)
    useEffect(() => {
    ...
    const tabs = [
        {
            id: 0,
            label: "Biodata",
            content: <FormBiodataAnakPegawai register={register} watch={watch} setValue={setValue} control={control} activeTab={activeTab} selectedTinggal={selectedTinggal} setSelectedTinggal={setSelectedTinggal} isLainnya={isLainnya} setLainnyaValue={setLainnyaValue} />
        },
        {
            id: 1,
            label: "Keluarga",
