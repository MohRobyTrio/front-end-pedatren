...
import FormBiodataKhadam from '../../content_modal/input/khadam/FormBiodata';
import FormKhadam from '../../content_modal/input/khadam/FormKhadam';
import Swal from 'sweetalert2';

export default function MultiStepModalKhadam({ isOpen, onClose, formState }) {
    const {
        register,
        handleSubmit,
        control,
    ...
    useEffect(() => {
        setValue("modalKhadam.tinggal_bersama", isLainnya ? lainnyaValue : selectedTinggal);
    ...
    const tabs = [
        {
            id: 0,
            label: "Biodata",
            content: <FormBiodataKhadam register={register} watch={watch} setValue={setValue} control={control} activeTab={activeTab} selectedTinggal={selectedTinggal} setSelectedTinggal={setSelectedTinggal} isLainnya={isLainnya} setLainnyaValue={setLainnyaValue} />
        },
        {
            id: 1,
            label: "Khadam",
            content: <FormKhadam register={register} />
        },
    ]
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4 overflow-y-auto">
                    ...
                    >
                        <Dialog.Panel className="bg-white p-6 rounded-lg shadow-xl max-w-3xl w-full h-full relative max-h-[90vh] flex flex-col">
                            ...
                            {/* Header */}
                            <div className="pb-4">
                                <Dialog.Title className="text-lg font-semibold text-gray-900">Tambah Data Khadam</Dialog.Title>
                            </div>
                            <form onSubmit={handleSubmit(onValidSubmit, onInvalidSubmit)} className="flex-1 overflow-y-auto p-2" ref={contentRef}>
                                {/* {renderStep()} */}
