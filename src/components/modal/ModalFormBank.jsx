...
export const ModalAddOrEditBank = ({ isOpen, onClose, data, refetchData, feature }) => {
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-2 sm:mt-0 text-left w-full">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label htmlFor="kode_bank" className="block text-gray-700">Kode Bank *</label>
                                                    <input
                                                        type="text"
                                                        id="kode_bank"
                                                        name="kode_bank"
                                                ...
                                                <div>
                                                    <label htmlFor="nama_bank" className="block text-gray-700">Nama Bank *</label>
                                                    <input
                                                        type="text"
                                                        id="nama_bank"
                                                        name="nama_bank"
