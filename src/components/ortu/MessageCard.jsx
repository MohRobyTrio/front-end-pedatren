...
export const MessageCard = ({ message, onEdit, onDelete, onToggleRead }) => {
    ...
    return (
        <div
            className={`bg-white rounded-lg shadow-sm transition-all duration-200 ${!message.tanggal_baca
            ...
            <div className="p-4 sm:p-6">
                <div className="flex items-start justify-between gap-3 mb-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div
                            className={`px-2 py-1 rounded-full text-xs font-medium ${message.tanggal_baca ? "bg-emerald-100 text-emerald-800" : "bg-red-100 text-red-800"
                                }`}
                        >
                            {message.tanggal_baca ? "Sudah Dibaca" : "Belum Dibaca"}
                        </div>
