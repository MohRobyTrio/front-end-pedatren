...
const FormBiodataAnakPegawai = ({ register, watch, setValue, control, activeTab }) => {
    ...
    const negara = watch("modalAnakPegawai.negara");
    const provinsi = watch("modalAnakPegawai.provinsi");
    const kabupaten = watch("modalAnakPegawai.kabupaten");
    const kecamatan = watch("modalAnakPegawai.kecamatan");
