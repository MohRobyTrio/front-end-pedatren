...
const FormBerkasAnakPegawai = ({ control, setValue, jenisBerkasList }) => {
    const [berkas, setBerkas] = useState([]);

    const watchedFiles = useWatch({
        control,
        name: jenisBerkasList.map(({ id }) => `modalAnakPegawai.file_${id}`)
    });
    ...
    const handleRemove = (jenisId) => {
        ...
        setValue(`modalAnakPegawai.file_${jenisId}`, null);
    };
...
export default FormBerkasAnakPegawai;
