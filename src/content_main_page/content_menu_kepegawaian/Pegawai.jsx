...
import useFetchPegawai from '../../logic/logic_menu_data_pokok/Pegawai';
                ...
                <div className="flex flex-wrap justify-between items-center mb-4">
                    <div className="bg-gray-100 p-3 rounded-md mt-2 w-full mb-4">
                        ...
                        <nav className="text-sm text-gray-500 mb-4">
                            <span>Kepegawaian</span> / <span className="text-blue-500">Pegawai</span>
                        </nav>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-3 listpesertadidik">
                        {loading ? (
                            ...
                            pegawai.map((item) => (
                                <div key={item.id_pegawai} className="bg-white p-4 rounded-lg shadow-md flex items-center space-x-4 cursor-pointer">
                                    <img
                                        alt={item.nama || "-"}
