...
const Tarik = () => {
    ...
    useEffect(() => {
        const savedView = sessionStorage.getItem("currentViewTransaksiTarik")
        if (savedView) {
    ...
    const handleSetView = (view) => {
        setCurrentView(view)
        sessionStorage.setItem("currentViewTransaksiTarik", view)
    }
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-2 sm:space-y-0">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-gray-900">Tarik Saldo</p>
                                </div>
                            </div>
                ...
                <>
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <div className="flex flex-col space-y-4">
                            ...
                            {/* <h3 className="text-lg font-semibold text-gray-900">Filter Data Tarik</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-lg">
                        <div className="px-6 py-4 border-b border-gray-200">
                            <h3 className="text-lg font-semibold text-gray-900">Riwayat Tarik</h3>
                        </div>
...
const Scan = ({ refetch }) => {
    ...
    const _recordTransaction = async () => {
        ...
        try {
            ...
            const token = sessionStorage.getItem("token") || getCookie("token")
            const endpoint = `${API_BASE_URL}saldo/tarik`
            ...
            setNominal("")
            setIdCard("")
            setSuccess("Tarik berhasil disimpan!")
            resetScan()
            refetch(true)
    ...
    useEffect(() => {
        ...
        if (location.pathname !== "/transaksi/saldo/tarik") return;
        ...
        <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Tarik Saldo</h2>
                ...
                {/* {currentStep === 1 && (
                    <>
                        <div className="bg-gray-50 rounded-xl p-4 sm:p-6 mb-6">
                            <h3 className="text-lg font-semibold text-gray-900 mb-4">Detail Tarik</h3>
