...
const PresensiSholat = () => {
  ...
  const { dataPresensi, loadingPresensi, totalData, fetchData, jadwalSholat, jadwalMendatang, statusPresensi } =
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex items-center justify-center gap-3 px-6 py-4 rounded-xl text-sm font-semibold transition-all flex-1 ${
                  currentView === "scan"
...
const AttendanceList = memo(({ setSearchTerm, filters, setFilters, loadingPresensi, dataPresensi = [], totals }) => {
                ...
                dataPresensi.map((student, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${
                          student.jenis_kelamin === "l" ? "bg-blue-100 text-blue-800" : "bg-pink-100 text-pink-800"
                        }`}
                      >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${
                          student.metode === "Kartu" ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800"
                        }`}
                      >
                        {student.metode}
                      </span>
      ...
      <div className="max-w-sm mx-auto sm:max-w-md">
        ...
        <div className="flex bg-white rounded-xl p-1 shadow-lg mb-4 sm:mb-6">
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center py-2 sm:py-3 px-3 sm:px-4 rounded-lg font-medium text-sm sm:text-base transition-all ${
              inputMode === "reader" ? "bg-blue-500 text-white shadow-md" : "text-gray-600 hover:bg-gray-50"
            }`}
          >
