...
import useFetchAccount from "../../hooks/hooks_menu_pembayaran/VirtualAccount";
import SearchBar from "../../components/SearchBar";
import Pagination from "../../components/Pagination";
import { ModalAddOrEditVirtualAccount } from "../../components/modal/ModalFormVirtualAccount";
    ...
    return (
        <div className="flex-1 pl-6 pt-6 pb-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Data Virtual Account</h1>
            ...
            <ModalAddOrEditVirtualAccount
                isOpen={openModal}
                onClose={() => setOpenModal(false)}
                data={vaData}
                refetchData={fetchAccount}
                feature={feature}
            />
                            ...
                            <table className="min-w-full text-sm text-left">
                                <thead className="bg-gray-100 text-gray-700 whitespace-nowrap">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2 border-b">Nomor VA</th>
                                ...
                                <tbody className="text-gray-800">
                                    {loadingAccount ? (
                                        ...
                                        account.map((item, index) => (
                                            <tr
                                                key={item.id}
                                                className="hover:bg-gray-50 whitespace-nowrap text-left"
                                            >
