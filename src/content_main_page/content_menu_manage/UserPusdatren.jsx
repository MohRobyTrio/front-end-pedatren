...
import useFetchUsers from "../../hooks/hooks_menu_manage/UserPusdatren";
import { ModalAddUser, ModalDetailUser, MultiStepModalUsers } from "../../components/modal/ModalFormProfil";
    ...
    return (
        <div className="flex-1">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Data User Pusdatren</h1>
            ...
            <ModalDetailUser isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} id={selectedId} />
