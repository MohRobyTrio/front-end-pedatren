    ...
    const handleSubmit = async (e) => {
        ...
        if (isProses) {
            const confirmResultlulus = await Swal.fire({
                ...
                text: "Pelajar ini akan diproses sebagai lulusan. Jika memiliki kartu RFID, kartu tersebut akan dinonaktifkan. Yakin ingin melanjutkan?",
                icon: "warning",
                showCancelButton: true,
            ...
            const confirmResultbatal = await Swal.fire({
                ...
                text: "Status lulusan pelajar ini akan dibatalkan. Jika sebelumnya memiliki kartu RFID, kartu tersebut akan diaktifkan kembali. Yakin ingin melanjutkan?",
                icon: "info",
                showCancelButton: true,
                confirmButtonText: "Ya, lanjutkan",
                cancelButtonText: "Batal",
