...
const Semester = () => {
    ...
    return (
        <div className="flex-1 pl-6 pt-6 pb-6">
            ...
            <ModalAddOrEditSemester isOpen={openModal} onClose={() => setOpenModal(false)} data={semesterData} refetchData={fetchSemester} />
                            ...
                            <table className="min-w-full text-sm text-left">
                                <thead className="bg-gray-100 text-gray-700 whitespace-nowrap">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2 border-b">Semester</th>
                                    ...
                                    {loadingSemester ? (
                                        ...
                                        semester.map((item, index) => (
                                            <tr key={item.id} className="hover:bg-gray-50 whitespace-nowrap text-left" onClick={() => {
                                                ...
                                                <td className="px-3 py-2 border-b capitalize">{item.semester}</td>
