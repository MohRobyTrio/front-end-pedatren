    ...
    return (
        <div className="space-y-6 p-4">
            ...
            <div>
                ...
                <p className="text-gray-600 mt-1">Informasi lengkap {selectedChild?.nama || "santri"}</p>
            </div>

            <div className="grid gap-6 lg:grid-cols-3">
                {/* Profile Card */}
                <div className="bg-white rounded-lg shadow p-6 text-center lg:col-span-1">
                    <div className="w-32 h-32 mx-auto mb-4 relative rounded-full overflow-hidden bg-emerald-100 flex items-center justify-center text-4xl font-semibold text-emerald-700">
                        {/* {mockChildProfile.photo ? ( */}
                            <img src={logoUser} alt={mockChildProfile.nama} className="w-full h-full object-cover" />
                        {/* ) : (
                            mockChildProfile.nama.charAt(0)
                        )} */}
                    </div>
                    <h2 className="text-xl font-medium">{selectedChild?.nama}</h2>
                    <div className="space-y-2 mt-2">
                        ...
                        <p className="text-sm text-gray-600">NIS: {selectedChild?.nis}</p>
