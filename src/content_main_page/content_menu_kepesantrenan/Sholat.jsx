...
// import useFetchGolongan from "../../hooks/hooks_menu_kepegawaian/Sholat";
    ...
    return (
        <div className="flex-1 p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Data Sholat</h1>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                {error ? (
                    ...
                    <>
                        <SearchBar
                            totalData={sholat.length}
                            onRefresh={() => fetchSholat(true)}
                            loadingRefresh={loadingSholat}
                            ...
                            <table className="min-w-full text-sm text-left">
                                <thead className="bg-gray-100 text-gray-700 whitespace-nowrap">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2 border-b">Urutan</th>
                                    ...
                                    {loadingSholat ? (
                                        ...
                                        sholat.map((item, index) => (
                                            <tr key={item.id} className="hover:bg-gray-50 whitespace-nowrap text-left">
                                                ...
                                                <td className="px-3 py-2 border-b">{item.urutan}</td>
                                                <td className="px-3 py-2 border-b w-30">
                                                    <span
                                                        className={`text-sm font-semibold px-3 py-1 rounded-full ${item.aktif == 1
