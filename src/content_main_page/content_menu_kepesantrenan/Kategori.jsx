...
import useFetchKategori from "../../hooks/hook_menu_kepesantrenan/belanja/Kategori";
import { ModalAddOrEditKategori, ModalDetailKategori } from "../../components/modal/ModalFormKategori";
...
const Kategori = () => {
    ...
    const { kategori, loadingKategori, error, fetchKategori, handleDelete, currentPage, setCurrentPage, totalPages, totalData } = useFetchKategori();
    ...
    return (
        <div className="flex-1 pl-6 pt-6 pb-6">
            ...
            <ModalAddOrEditKategori isOpen={openModal} onClose={() => setOpenModal(false)} data={kategoriData} refetchData={fetchKategori} feature={feature} />
                            ...
                            <table className="min-w-full text-sm text-left">
                                <thead className="bg-gray-100 text-gray-700 whitespace-nowrap">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2 border-b">Nama Kategori</th>
                                    ...
                                    {loadingKategori ? (
                                        ...
                                        kategori.map((item, index) => (
                                            <tr key={item.id} className="hover:bg-gray-50 whitespace-nowrap text-left cursor-pointer" onClick={() => {
                                                ...
                                                <td className="px-3 py-2 border-b">{item.nama_kategori}</td>
