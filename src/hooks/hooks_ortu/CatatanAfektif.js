...
const useFetchCatatanAfektifOrtu = () => {
    ...
    const fetchData = useCallback(async (force = false) => {
            let url = `${API_BASE_URL}view-ortu/catatanAfektif?santri_id=${activeChild?.id || idSantri}`;
...
export default useFetchCatatanAfektifOrtu;
