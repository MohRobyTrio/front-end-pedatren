  ...
  const fetchData = useCallback(
    async (force = false) => {
      ...
      if (filters?.status_pelanggaran && filters.status_pelanggaran !== "") {
        url += `&status_pelanggaran=${encodeURIComponent(
          filters.status_pelanggaran
        )}`;
      }
      if (filters?.jenis_putusan && filters.jenis_putusan !== "")
        url += `&jenis_putusan=${encodeURIComponent(filters.jenis_putusan)}`;
      if (filters?.jenis_pelanggaran && filters.jenis_pelanggaran !== "") {
        url += `&jenis_pelanggaran=${encodeURIComponent(
