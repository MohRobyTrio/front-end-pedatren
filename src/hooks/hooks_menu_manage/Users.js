...
//                 const firstResponse = await fetch(`${API_BASE_URL}crud/users?page=1&per_page=1`, {
//                     headers: {
//                         "Content-Type": "application/json",
//                         Authorization: `Bearer ${token}`,
//                     },
...
//                 const fullResponse = await fetch(`${API_BASE_URL}crud/users?page=1&per_page=${total}`, {
//                     headers: {
//                         "Content-Type": "application/json",
//                         Authorization: `Bearer ${token}`,
//                     },
...
//                 setAllUsers(kelasList);
//                 sessionStorage.setItem("allUsers", JSON.stringify(kelasList));
//             } catch (err) {
...
//         fetchAllUsers(); // panggil hanya jika belum ada di session
//     }
// // eslint-disable-next-line react-hooks/exhaustive-deps
// }, []); // ⚠️ Dependency array kosong = hanya dijalankan sekali saat mount
    ...
    return {
        ...
        fetchUsers,
        handleDelete,
        handleToggleStatus, limit, setLimit, totalPages, currentPage, setCurrentPage, totalDataUsers
    };
};
